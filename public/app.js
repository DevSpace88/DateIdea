...
//         }
//
//         const totalLocations = Object.values(cityLocations).flat().length;
//
//         if (totalLocations === 0) {
//             // Wenn keine echten Orte gefunden wurden, verwende Fallback
//             generateFallbackLocations(city);
//             apiStatus.textContent = `Keine echten Orte in ${city} gefunden, verwende simulierte Daten`;
//         } else {
//             loadedCity = city;
//             apiStatus.textContent = `${totalLocations} Orte in ${city} geladen`;
//         }
//
//         return true;
//     } catch (error) {
...
//         }
//
//         // 2-5 Orte pro Kategorie generieren
//         const numLocations = Math.floor(pseudoRandom(citySeed + category) * 4) + 2;
//
...
// });
//
// // Neue Idee ohne Radanimation generieren
...
//     if (spinning) return;
//
//     // Wenn keine Orte geladen sind, versuche sie zu laden
//     const city = cityInput.value.trim();
//     if (Object.keys(cityLocations).length === 0) {
//         const success = await loadLocations(city);
//         if (!success) {
//             // Auch bei Fehlern weitermachen, da wir Fallback haben
//             generateFallbackLocations(city);
//         }
//     }
//
